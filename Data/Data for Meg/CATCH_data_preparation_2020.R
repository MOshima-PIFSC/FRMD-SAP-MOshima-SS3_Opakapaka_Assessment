...
areasReggie=read.csv("./FRMD-SAP-MOshima-SS3_Opakapaka_Assessment/Data/Data for Meg/BF_Area_Grid_Reggie.csv",header=T)
...
write.csv(final_reported_table,"./FRMD-SAP-MOshima-SS3_Opakapaka_Assessment/Data/Data for Meg/Reported_catch_table.csv",row.names=T)
